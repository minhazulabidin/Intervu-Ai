...
export const LogoAnimation = ({ isFlying = false, flyTo = null }) => {
  ...
  return (
    <motion.div
      variants={isFlying ? flyVariants : undefined}
      initial="initial"
      animate={isFlying ? "fly" : "initial"}
    ...
    >
      <motion.svg
        ...
        height="120"
        viewBox="0 0 48 48"
        variants={isFlying ? containerVariants : undefined}
        initial="initial"
        animate={isFlying ? "fly" : "initial"}
        ...
        <defs>
          ...
          >
            <motion.stop
              offset="0%"
              stopColor="#AC6AFF"
              animate={{ stopColor: ["#AC6AFF", "#EC4899", "#AC6AFF"] }}
              transition={{
                duration: 3,
                repeat: Infinity,
                ease: "easeInOut",
            ...
            <motion.stop
              offset="100%"
              stopColor="#EC4899"
              animate={{ stopColor: ["#EC4899", "#8B5CF6", "#EC4899"] }}
              transition={{
                duration: 3,
                repeat: Infinity,
                ease: "easeInOut",
