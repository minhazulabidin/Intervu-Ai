    ...
    <main className="relative overflow-hidden bg-black text-white">
      ...
      <section className="relative px-4 sm:px-6 mb-28 md:mb-40">
        <div className="max-w-7xl mx-auto">
          {/* Top Blur */}
          <div className="absolute left-1/2 -translate-x-1/2 top-0 w-72 md:w-137.5 h-72 md:h-137.5 bg-purple-500/10 blur-[120px] rounded-full pointer-events-none" />
          ...
          <div className="relative z-10 grid grid-cols-1 xl:grid-cols-2 gap-8 lg:gap-12 items-center my-10">
            {/* LEFT SIDE */}
            <div className="space-y-5 md:space-y-6">
              {[
                ...
                <Effect
                  ...
                  once={true}
                >
                  <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/4 backdrop-blur-2xl p-5 md:p-7 hover:border-pink-500/20 transition-all duration-500">
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-linear-to-br from-pink-500/8 to-purple-500/5 transition duration-500" />
            ...
            <Effect
              ...
              once={true}
            >
              <div className="group relative overflow-hidden rounded-[32px] border border-white/10 bg-white/4 backdrop-blur-2xl p-6 md:p-10 mt-10">
                {/* Hover Glow */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-linear-to-br from-pink-500/8 via-purple-500/5 to-transparent transition duration-700" />
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <Effect
                        ...
                        once={true}
                      >
                        <div className="flex items-start gap-4 rounded-2xl border border-white/10 bg-white/3 p-4 md:p-5">
      ...
      <section className="relative px-4 sm:px-6 mb-28 md:mb-40">
        {/* Background Glow */}
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-72 md:w-125 h-72 md:h-125 bg-pink-500/10 blur-[120px] rounded-full pointer-events-none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mt-10">
            {[
              ...
              <Effect
                ...
                once={true}
              >
                <div className="group relative overflow-hidden rounded-[28px] border border-white/10 bg-white/4 backdrop-blur-2xl p-6 md:p-8 hover:-translate-y-2 transition-all duration-500 hover:border-pink-500/20">
                  {/* Hover Gradient */}
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-linear-to-br from-pink-500/8 via-purple-500/5 to-transparent transition duration-700" />
