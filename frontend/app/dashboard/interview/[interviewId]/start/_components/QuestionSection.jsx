    ...
    return mockInterviewQuestion && (
        <div className='p-5 rounded-lg border my-10'>
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
                {
                    mockInterviewQuestion && mockInterviewQuestion.map((item, idx) => (
            ...
            <h2 className='my-5 text-sm md:text-md'>{mockInterviewQuestion[activeIndex]?.question}</h2>
            <Volume2 className='cursor-pointer' onClick={() => textToSpeech(mockInterviewQuestion[activeIndex]?.question)} />
